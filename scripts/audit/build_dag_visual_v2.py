...
def build_dag_figure(out_dir: Path) -> None:
    ...
    svg = out_dir / "Figura_S2_DAG_v2.svg"
    png = out_dir / "Figura_S2_DAG_v2.png"
    pdf = out_dir / "Figura_S2_DAG_v2.pdf"
...
def main() -> None:
    print("Figura S2 v2 (líneas rectas + jerarquía visual) — archivo separado:")
    for d in [OUT_DIR, ROOT / "data" / "output" / "Post_Auditoria" / "Suplementario"]:
        build_dag_figure(d)
